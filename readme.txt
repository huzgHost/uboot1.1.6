...
========================== 2019/07/17 支持nandflash启动  ===========================
1，支持nandflash启动
	一，修改start.S,为了使能nandflash，需要配置clock等
...
1，读取nor-flash出错，这里采用原始办法读出norflash信息;
2，使用网络下载固件(目前只支持 nfst, tftp一直出错，原因还未找到)
	> nfs 0x30000000 192.168.2.123:/work/nfs_root/u-boot.bin
	> nand erase bootloader	或者 nand erase 0x0 0x40000		(0x0:偏移地址, 0x40000:烧录大小)
	> nand write.jffs2 0x30000000 bootloader $(filesize) 或者 nand write.jffs2 0x30000000 0x0 $(filesize)  (0x30000000: 源地址, 0x0:偏移地址, $(filesize):烧录的大小)
====================================================================================
